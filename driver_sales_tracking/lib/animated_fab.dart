...
class _AnimatedFabState extends State<AnimatedFab>
  ...
  void initState() {
    ...
    _colorAnimation =
        new ColorTween(begin: Colors.orange, end: Colors.orange[800])
        ...
        builder: (BuildContext context, Widget? child) {
          return new Stack(
            ...
            children: <Widget>[
              ...
              _buildOption(Icons.add_circle, 0.0),
              _buildOption(Icons.play_circle_fill, -math.pi / 3),
              _buildOption(Icons.pause_circle_filled, -2 * math.pi / 3),
              _buildOption(Icons.account_circle_rounded, math.pi),
              _buildFabCore(),
            ],
          );
        },
