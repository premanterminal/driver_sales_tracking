import 'package:driver_sales_tracking/multicity_input.dart';
import 'package:driver_sales_tracking/price_tab/price_tab.dart';
...
class _ContentCardState extends State<ContentCard> {
  ...
  Widget _buildTabBar({required bool showFirstOption}) {
    return Stack(
      children: <Widget>[
        new Positioned.fill(
          top: null,
